\begin{figure}[h!]
  \begin{center}
    \begin{tikzpicture}[scale=.8]
      ...
      \node (x) at (-0.8, 0.8) {$x$};
      \node (y) at (10, 0.8) {$f(x)$};
      \draw[dashed] (0, 0) ellipse (3cm and 3cm) node[above right, xshift=2.2cm, yshift=2cm] {$\mathcal{X}$};
      ...
      \draw[->, thick] (4, 0.8) -- (6.3, 0.8) node[midway, above] {$f$};
  ...
  \caption{Função $f : \mathcal{X} \to Y$ \textit{$(\alpha, \lambda)$-limitada} em $x$.}
\end{figure}
