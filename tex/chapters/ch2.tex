...
\en{In \cite{Toeplitz1911} Otto Toeplitz introduced the $L$-forms, previously studied in his postdoctoral thesis at the University of Göttingen. Later, his studies were adapted to what we now call Toeplitz matrices.}
...
\begin{theorem}[\pt{Norma de matrizes de Toeplitz de banda}\en{Norm of banded Toeplitz matrices}] \label{norm}
  \pt{Seja $M$ uma matriz de Toeplitz possivelmente infinita com entradas reais e banda $k$. Então, a norma espectral de $M$, denotada por $\| M \|_2$, satisfaz}
...
\pt{\[
  ...
  \]}
\en{\[
    \| v \|_p = \left( \sum_{i=1}^{n} |v_i|^p \right)^{1/p} \quad \text{for } p < \infty, \quad \text{and} \quad \| v \|_\infty = \max_{1 \leq i \leq n} |v_i|.
  \]}
...
\en{In this chapter, the main results of the theory of Toeplitz matrices that underpin the subsequent analyses of this work have been established. The properties and theorems presented provide the mathematical tools necessary for the enumeration of $k$-bounded functions discussed in the next chapter.}
