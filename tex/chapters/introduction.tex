...
\en{In the second chapter, we introduce the definition of Toeplitz matrices, along with relevant results that are used in the third chapter, as well as in possible generalizations of the theorems presented therein.}
...
\en{Subsequently, in the third chapter we extend a result from \cite{coulson} by finding the asymptotic characterization of the number of $(k,1)$-bounded functions on $[n]$:}
