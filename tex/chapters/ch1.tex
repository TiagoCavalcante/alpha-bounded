...
\begin{theorem}
  ...
  \en{Let $(X, d_X)$ and $(Y, d_Y)$ be metric spaces, and $\mathcal{X} \subseteq X$. Every Lipschitz continuous function, with constant $K$, $f \colon \mathcal{X} \to Y$ is $K$-bounded.}
\end{theorem}
\begin{proof}
  \pt{Para todo $x_1, x_2 \in \mathcal{X}, d_X(x_1, x_2) \le 1$ e consequentemente $d_Y(f(x_1), f(x_2)) \le K d_X(x_1, x_2) \le K$.}
  \en{For every $x_1, x_2 \in \mathcal{X}$, $d_X(x_1, x_2) \le 1$, hence $d_Y(f(x_1), f(x_2)) \le K d_X(x_1, x_2) \le K$.}
\end{proof}
